...
def main(argv):
  ...
  report('/tmp/cars.pdf', 'Sales summary for last month', new_summary, cars_dict_to_table(data))
  # TODO: send the PDF report as an email attachment
  msg = email_generate("automatiton@example.com", "student-00-e062fce352ed@example.com", "Sales summary for last month", new_summary, "/tmp/cars.pdf")
  email_send(msg)
